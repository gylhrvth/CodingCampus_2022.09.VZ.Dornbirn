...
public class TicTacToeDeutschV1c {
    private int[][] board;
    private int spielerAmZug;
    private int spielTiefe;
    private int bestMove;

    public TicTacToeDeutschV1c() {
    ...
    public String resultGame() {
        ...
        else if (wert == 1) return "!!Du bist der Gewinner!!";
        else return "!!Du bist der Verlierer!!";
    }
    ...
    public static void main(String[] args) {
        TicTacToeDeutschV1c ttt = new TicTacToeDeutschV1c();
        ...
        while (true) {
            ttt.showBoard();
            System.out.println("Ihr Zug, zuerst Spalte und dann Reihe: ");
